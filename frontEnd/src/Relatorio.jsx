...
import RelatorioGado from './RelatorioGado'
...
function Relatorio() {
  ...
  const [dateSaida, setDateSaida] = useState('');
    ...
    //EFEITO CLICK BTNADDCAFE
    const handleMouseClickIn = () => {
        const btnaddproduto = document.querySelector(".btnCafe")
...
//EFEITO CLICK BTNADDGADO
      const handleGadoClickIn = () => {
        const btnaddproduto = document.querySelector(".btnGado")
        btnaddproduto.style.transform = "translateY(3px)";
      };
    
      const handleGadoClickOut = () => {
        const btnaddgado = document.querySelector(".btnGado")
        btnaddgado.style.transform = "translateY(0px)";
      };
...
const handleButtonRelatorioCafe = () => {
  setDestination("relatorioCafe");
};
