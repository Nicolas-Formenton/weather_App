...
function MenuBar(props) {
    ...
    const { exibirBarraSuperiorRelatorio, exibirBarraSuperiorCafe, exibirBarraSuperiorGado } = props;
    ...
    <div className='barra'>
        ...
        <svg height="50px" width="50px" fill="#204b5e" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"> <title>report</title> <path d="M6 11h4v17h-4v-17zM22 16v12h4v-12h-4zM14 28h4v-24h-4v24z"></path> </g></svg>
        </div>
    </div>
    );
