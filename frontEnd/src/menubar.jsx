...
function MenuBar(props) {
    ...
    const { exibirBarraSuperiorRelatorio, exibirBarraSuperiorCafe, exibirBarraSuperiorGado, exibirBarraSuperiorHome } = props;
