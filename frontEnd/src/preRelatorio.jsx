...
import preRelatorio from './style/preRelatorio.css'
...
function preRelatorio() {
    ...
    const handleMouseClickIn = () => {
      ...
      const exibirBarraSuperiorHome = true;
