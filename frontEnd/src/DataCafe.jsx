          ...
          <form className='divInput'>
            ...
            <div className='divListaCafe'>
              {/* {[...new Set(produtos)].map((produto, index) => (
                ...
                <div className='itemCafe' onClick={handleButtonValores}>ITEM 1</div>
            </div>
